...
DROP POLICY IF EXISTS "Public goods_receipts select" ON goods_receipts;
DROP POLICY IF EXISTS "Public goods_receipts insert" ON goods_receipts;
DROP POLICY IF EXISTS "Public goods_receipts update" ON goods_receipts;
DROP POLICY IF EXISTS "Public goods_receipts delete" ON goods_receipts;
CREATE POLICY "Public goods_receipts select" ON goods_receipts FOR SELECT USING (true);
CREATE POLICY "Public goods_receipts insert" ON goods_receipts FOR INSERT WITH CHECK (true);
CREATE POLICY "Public goods_receipts update" ON goods_receipts FOR UPDATE USING (true);
CREATE POLICY "Public goods_receipts delete" ON goods_receipts FOR DELETE USING (true);
